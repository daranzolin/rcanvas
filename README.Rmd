...
Some prep work is required before use. You must first safely stash your Canvas
API token into your operating system's keyring.  This only needs to be done once.
...
Do not save your token or the code above in an `.R` file because it could
compromise the security of your token. 

Each time you run load the `rcanvas` library you need to set your domain like
this:
